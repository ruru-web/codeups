...
//   });
  ...
  $(document).ready(function () {
    ...
    $(".archive-list__year").on("click", function () {
      const $yearBlock = $(this); // ▶2023 のブロック全体
      const $icon = $yearBlock.find(".archive-list__toggle"); // ▶ を探す
      const $monthList = $yearBlock.next(".archive-list__month"); // 次の月リストを探す
